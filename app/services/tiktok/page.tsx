  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-gray-900 dark:text-gray-200 text-xs md:text-xl font-normal mb-8">
            Our team of creative experts crafts compelling video content that
            resonates with your target audience on TikTok.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src={timelineImg2}
      ...
      content: (
        <div>
          <p className="text-gray-900 dark:text-gray-200 text-xs md:text-xl font-normal mb-4">
            We manage your TikTok Shop campaigns from launch to optimization to
  ...
  const pricingPlans = [
    {
      ...
      description:
        "Perfect for beginners looking to establish their TikTok store presence with essential setup and support.",
      monthlyPrice: 1300,
      link: "/contact-us",
      features: [
    ...
    },
    {
      name: "3 MONTHS PLUS",
      description:
        "Ideal for sellers who need comprehensive product research and optimized listings to drive their initial sales.",
      monthlyPrice: 1999,
      link: "/contact-us",
      features: [
        "TikTok Shop Account Setup",
    ...
    },
    {
      ...
      description:
        "Best for those aiming for a fully optimized store with end-to-end support, marketing assistance, and customer engagement.",
      monthlyPrice: 4500,
      link: "/contact-us",
      features: [
        "TikTok Shop Account Setup",
