        ...
        <>
            ...
            <section className="w-full">
                <div className="flex flex-col mx-auto w-[320px] md:container gap-5 px-2 md:px-10 lg:px-20">
                    <p className='text-lg'>
                        These Terms and Conditions are intended to detail our obligations to you regarding our site as well as inform you of the rules and regulations of Ecom Pinnacle, LLC. By using this site (Ecom Pinnacle), you agree to these Terms and Conditions, and as such we strongly encourage our visitors to read through this content regularly to stay informed of this disclaimer and any change to our Terms and Conditions. In the following Terms and Conditions, “we, us, and site” are used to refer to Ecom Pinnacle, LLC.
                    ...
                    <p className='text-lg'>
                        You are permitted to use this site for you own purposes to print, download, and share material provided you do not modify any content without our explicit consent. Material on this website may not be republished online or offline without our permission. The copyright and all intellectual property rights of the material on this site are owned by Ecom Pinnacle, LLC and may not be reproduced without our prior consent.
                    </p>
                    <br />
                    <p className='text-lg'>
                    ...
                    <p className='text-lg'>
                        In order to provide additional information or services, Ecom Pinnacle, LLC may include links to external websites. Clicking on such a link will navigate you away from Ecom Pinnacle’s site. The inclusion of links does not necessarily imply a recommendation, nor does it in any way endorse the views expressed within them. Other site’s Terms and Conditions may differ from our own. When clicking off the Ecom Pinnacle, LLC site, we strongly encourage you to visit the other site’s Terms and Conditions to ensure it meets the standards of your own personal preferences.
                    </p>
                    <br />
                    <h1 className="text-3xl font-semibold">
                    ...
                    <p className='text-lg'>
                        In no event will Ecom Pinnacle, LLC be held liable for any loss or damage of information including but not limited to indirect or consequential loss or damage, loss or damage of data, or profits arising out of or in connection with the use of this website. Ecom Pinnacle, LLC may not be held liable or responsible in any way for loss or damage that may result to you or a third party as a result of your use of our website.
                    </p>
                    <br />
                    <p className='text-lg'>
