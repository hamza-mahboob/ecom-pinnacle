  ...
  const values = [
    {
      ...
      description:
        "Ecom Pinnacle drives sustainable, high-impact growth with tailored, data-driven strategies focused on long term success.",
    },
    {
      title: "Results Integrity",
      description:
        "Our commitment to transparency and accountability ensures measurable, ROI-driven outcomes aligned with client goals.",
    },
    {
      title: "Team Agility",
      description:
        " Our skilled, adaptable team quickly responds to industry shifts, delivering innovative solutions that meet evolving business needs.",
    },
  ];
        ...
        <div className="flex flex-col xl:flex-row items-center lg:justify-around py-[96px]">
          <div className="flex flex-col mb-28 lg:mb-0 gap-32 text-center lg:text-start">
            <div className="w-full lg:w-[560px] ">
              ...
              <p className="py-5">
                We are dedicated to provide maximum benefits to our clients with
                seamless strategies and best investment options.
              </p>
            </div>
            ...
            {values.map((value, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-5">
                  <h2 className="text-2xl font-medium text-titleColor">
                    {value.title}
                  </h2>
